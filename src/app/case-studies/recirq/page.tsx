...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "RecirQ",
      item: "https://alphabyte.ai/case-studies/recirq/",
    },
  ],
};
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="text-body text-muted-foreground max-w-[55ch]">
              ...
              built the RecirQ Claude environment, book a Strategy Sprint or get
              in touch.
            </p>
          </div>
        </div>
