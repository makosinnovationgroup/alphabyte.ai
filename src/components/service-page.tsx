...
export function ServicePage({
  ...
  return (
    <main>
      {/* Breadcrumb */}
      <nav aria-label="Breadcrumb" className="bg-canvas px-6 pt-6 md:px-10 lg:px-16">
      ...
      <section className="px-6 py-12 md:px-10 md:py-16 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-md border border-border-default bg-white p-6 md:p-10">
            <h2 className="mb-6 text-body-sm font-bold uppercase tracking-brand-wide text-foreground md:mb-8">
