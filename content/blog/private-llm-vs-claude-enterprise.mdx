...
Claude Enterprise's zero-retention model satisfied the requirement without any on-premise infrastructure. If you are building a governance framework for the first time, our [AI governance framework for mid-market](/blog/ai-governance-framework-mid-market/) post walks through how to distinguish between regulatory and preferential constraints.

[Deloitte's "State of AI in the Enterprise" survey](https://www.deloitte.com/global/en/issues/data-and-analytics/state-of-ai-in-the-enterprise.html) found that data privacy and security concerns remain the most cited barrier to AI adoption. Organisations which conducted specific policy reviews, rather than applying blanket restrictions, were significantly more likely to move into production deployment.
...
For Canadian organisations, [PIPEDA](https://www.priv.gc.ca/en/privacy-topics/privacy-laws-in-canada/the-personal-information-protection-and-electronic-documents-act-pipeda/) requires that personal information be protected by appropriate safeguards during processing. Zero-retention processing, SOC 2 compliance, and administrative access controls satisfy this standard for most use cases. The [shadow AI governance](/blog/shadow-ai-governance/) risk is often greater: employees using ungoverned consumer AI tools with no data handling guarantees at all.
...
[McKinsey's 2024 "The state of AI" survey](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) noted that only a minority of organisations reported deploying self-hosted models, and that the primary driver in nearly every case was a specific regulatory mandate rather than a general security preference. For more detail on what the [Infrastructure service](/services/infrastructure/) involves when on-premise is the right call, that page covers the full engagement model.
...
We saw this directly when building an [executive productivity suite](/our-work/circular-economy-platform/) with purpose-built Claude agents: the quality of [Claude's reasoning](/tools/claude/) on complex cross-system queries was materially better than what open-weight alternatives produced.
