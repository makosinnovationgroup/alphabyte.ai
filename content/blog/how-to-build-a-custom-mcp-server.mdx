...
The compliance deployment we built for a construction firm followed this pattern. Regulatory code records are sensitive. The [MCP server enforced the same access boundaries](/our-work/construction-compliance-agent/) the team already operated under. No new permission model. No additional risk surface.
